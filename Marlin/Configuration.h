...
#define MACHINE_UUID "64442dd6-2b26-4d6c-a838-a434b908d08f"
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 216.5 // mm

  // Horizontal offset from middle of printer to smooth rod center.
  #define DELTA_SMOOTH_ROD_OFFSET 142.2 // mm

  // Horizontal offset of the universal joints on the end effector.
  #define DELTA_EFFECTOR_OFFSET 30.0 // mm

  // Horizontal offset of the universal joints on the carriages.
  #define DELTA_CARRIAGE_OFFSET 13.0 // mm
...
#define MANUAL_Z_HOME_POS 320.6
...
#define DEFAULT_MAX_FEEDRATE          {400, 400, 400, 300}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {7000,7000,6500,4000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
